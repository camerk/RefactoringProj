...
public class Customer {
    ...
    public String statement() {
        ...
        result += "You earned " + String.valueOf(getTotalFreqRenterPoins()) + " frequent renter points";
    ...
    private String htmlStatement(){
        ...
        result += "<p>You earned <b>" + String.valueOf(getTotalFreqRenterPoins()) + "frequesnt renter points</b></p>";
        return result;
    }
    ...
    private int getTotalFreqRenterPoins(){
        int total = 0;
        for (Rental rental : rentals){
